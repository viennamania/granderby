...
import { ToggleColumns } from '@/components/ui/doingdoit/table';
import { PiMagnifyingGlassBold, PiFunnel, PiXBold } from 'react-icons/pi';

import { Button } from '@/components/ui/doingdoit/button';

import { ActionIcon } from '@/components/ui/doingdoit/action-icon';

import { Input } from '@/components/ui/doingdoit/input';
import { Title } from '@/components/ui/doingdoit/text';
import cn from '@/utils/class-names';

import { useMedia } from '@/hooks/use-media';

const Drawer = dynamic(
  () => import('@/components/ui/doingdoit/drawer').then((module) => module.Drawer),
  { ssr: false }
);
