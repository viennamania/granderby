...
import Feeds from './feeds-jockey-granderby';
        ...
        */}
        ...
        <div className="mt-5 flex flex-row items-center justify-start gap-3 ">
          <span className=" text-xl font-bold xl:text-2xl">
            Granderby Jockey NFT
          </span>

          <button
            onClick={() =>
              router.push(
                `https://polygonscan.com/token/${nftDropContractAddressJockey}`
              )
            }
          >
            <Image
        ...
        <span className="mt-3 text-xs lg:text-sm xl:text-lg">
          Items 50 · Created Jun 2023 · Creator earnings 0% · Chain Polygon ·
          Category Gaming
        </span>
      </div>
            ...
            <div className="relative z-10 mb-6 flex items-center justify-between ">
              <div className="flex flex-col gap-2 ">
                <div className="text-lg font-bold xl:text-2xl">
                  {jockeysCount} {jockeysCount > 1 ? 'Jockeys' : 'Jockey'}
                </div>
