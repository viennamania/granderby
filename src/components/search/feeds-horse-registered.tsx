        ...
        */}
          ...
          {searchData?.pages.map((page) => (
            <div
              key={page.pageKey}
              className={cn(
                'mb-5 grid grid-cols-2 gap-5 sm:grid-cols-5 md:grid-cols-5  xl:grid-cols-10',
                isGridCompact
              ...
              {page.nfts?.map((nft: any) => (
                ...
                >
                   ...
                   */}
                    ...
                    <div className=" h-18 xl:h-18  mb-2 mt-4 flex  w-full flex-col  items-center  justify-center gap-1   ">
                      <div className=" h-10 text-sm font-bold ">
                        {nft?.title}
                      </div>
