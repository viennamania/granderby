  ...
  */
  ...
  /*

        {
          idx: '7556',
          Horse_Uid: '20',
          TEXTURE_KEY: 'Hrs_00000000',
          Before_WithDraw: 21060,
          WithDraw: 21060,
          Result_WithDraw: 0,
          regTime: '2024-04-30T10:47:16.097Z'
        }
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">Before Amount</div>,
    accessor: 'Before_WithDraw',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
  ...
  {
    Header: () => (
      <div className="ltr:ml-auto rtl:mr-auto">Withdraw Amount</div>
    ),
    accessor: 'WithDraw',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
  ...
  {
    Header: () => <div className="ltr:ml-auto rtl:mr-auto">After Amount</div>,
    accessor: 'Result_WithDraw',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      <div className="-tracking-[1px] ltr:text-right rtl:text-left">
        <strong className="mb-0.5 flex items-center justify-end text-base md:mb-1.5 md:text-lg lg:text-base 3xl:text-2xl">
...
export default function ClaimHistoryTable({
  ...
  console.log('ClaimHistoryTable tokenid: ', tokenid);
  ...
  useEffect(() => {
    const getBalanceHistory = async () => {
      ...
      const response = await fetch('/api/nft/getClaimHistoryByTokenId', {
        method: 'POST',
