...
export default function SaleHistoryTable(
  ...
  */
  ...
  return (
    <div
      className={cn(
        'flex w-full flex-col items-center justify-start rounded-lg border bg-white p-5 dark:bg-light-dark'
      )}
    >
      {/*
  ...
  */}
      ...
      */}
      ...
      <div className="-mx-0.5 w-full dark:[&_.os-scrollbar_.os-scrollbar-track_.os-scrollbar-handle:before]:!bg-white/50">
