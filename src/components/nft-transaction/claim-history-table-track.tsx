...
const COLUMNS = [
  {
    ...
    accessor: 'claimedBalance',
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      <div className="ml-1 text-left text-lg -tracking-[1px]">{value}</div>
    ),
    minWidth: 150,
    maxWidth: 150,
  },

  {
    ...
    // @ts-ignore
    Cell: ({ cell: { value } }) => (
      <div className="text-sm -tracking-[1px] ltr:text-right rtl:text-left">
...
/*
  /api/nft/getClaimTrackHistoryByHolder?holderAddress=0x54C19eD3D131307e5D6B50d28Ea1E7A12ac52Af0
  {
    "_id": "66b1a2fede711874d6cd78b2",
    "holderAddress": "0x54C19eD3D131307e5D6B50d28Ea1E7A12ac52Af0",
    "claimedBalance": 10000,
    "transactionHash": "0xf53e0f6360d7ce607cbfba8244cc4d33bcf326d6cf52bb8678ad96a467432245",
    "createdAt": "2024-08-06T04:13:50.096Z",
    "updatedAt": "2024-08-06T04:13:50.096Z",
    "__v": 0
  }
  */
...
export default function ClaimHistoryTable({
  ...
  console.log('ClaimHistoryTable holderAddress: ', holderAddress);
  ...
  useEffect(() => {
    const getBalanceHistory = async () => {
      ...
      const res = await fetch(
        '/api/nft/getClaimTrackHistoryByHolder?holderAddress=' + holderAddress,
        {
          method: 'GET',
      ...
      console.log('getClaimTrackHistoryByHolder data: ', data);

      if (!data.trackClaims) {
        return;
      }

      setTransactions(data.trackClaims);
    };
