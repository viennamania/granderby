  ...
  return (
    <>
      ...
      <div className="flex-cols mt-5 flex items-center justify-center gap-3 rounded-lg bg-sky-600 pb-5 pt-5 text-white">
        <div className="text-2xl font-bold">Charge GDP</div>
      </div>
      ...
      <div className="mx-auto flex w-full shrink-0 flex-col md:px-4 xl:px-6 3xl:max-w-[1700px] 3xl:px-12">
        ...
        */}
        ...
        {address ? (
          <div className="mb-7 flex flex-row items-center justify-center gap-2 text-center text-2xl font-bold tracking-tighter text-gray-900 dark:text-white  lg:text-5xl ">
            <Image
      ...
      <form>
        <div className=" flex flex-row items-center justify-center text-lime-600">
          {/* Form Section */}
          <div className={styles.collectionContainer}></div>
        </div>
      </form>
