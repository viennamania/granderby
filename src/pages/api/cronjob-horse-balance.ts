  ...
  horses.forEach(async (horse: any) => {
    ...
    if (Number(horse.tokenId) === 0) {
      ...
      if (Number(horse.tokenId) >= 11 && Number(horse.tokenId) <= 58) {
        ...
        // B Grade
      } else if (Number(horse.tokenId) >= 59 && Number(horse.tokenId) <= 299) {
        ...
        // C Grade
      } else if (Number(horse.tokenId) >= 300 && Number(horse.tokenId) <= 599) {
      ...
      } else if (Number(horse.tokenId) >= 600 && Number(horse.tokenId) < 1000) {
